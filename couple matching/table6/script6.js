...
//     console.log("Boy's Rashi:", tablesix(boyName));
//     console.log("Girl's Rashi:", tablesix(girlName));

//     displayValue(tablesix(boyName), tablesix(girlName));
// }



// const boysRashi = ["deva", "manushya", "rakshasa"];

// const girlsRashi = ["deva", "manushya", "rakshasa"];
...
// function displayValue(boy, girl) {

//     const rowIndex = girlsRashi ? girlsRashi.indexOf(girl) + 1 : 0;
//     const columnIndex = boysRashi ? boysRashi.indexOf(boy) + 1 : 0;
...
function submit() {
    var boyNamenakshtra = document.getElementById("bname").value.toLowerCase();
    var girlNamenakshtra = document.getElementById("gname").value.toLowerCase();

    var boyNakshatra = "";
    var girlNakshatra = "";

    for (var i = 1; i <= Math.min(4, Math.max(boyNamenakshtra.length, girlNamenakshtra.length)); i++) {
        var bSubstring = boyNamenakshtra.substring(0, i);
        var gSubstring = girlNamenakshtra.substring(0, i);
        ...
        if (currentBoyNakshatra !== "not matching") {
            boyNakshatra = currentBoyNakshatra;
        }

        if (currentGirlNakshatra !== "not matching") {
            girlNakshatra = currentGirlNakshatra;
        }
    }

    if (boyNakshatra !== "" && girlNakshatra !== "") {
        
        submitSecondJs(boyNakshatra, girlNakshatra);
    } else {
...
function submitSecondJs(boyNakshatra, girlNakshatra) {
    var boyRashi6 = tablesix(boyNakshatra);
    var girlRashi6 = tablesix(girlNakshatra);
